...
public class CustomerService {
    ...
    public boolean registerCustomer(Customer newCustomer){
        ...
        System.out.println("CustomerService::validateLogin_IDNotUsed() : Customer has been persisted: " + persistedCustomer);
        return true;
    }

    private boolean validateCustomerInput(Customer newCustomer){
        System.out.println("CustomerService::validateTrainerInput() : checking Login ID validation.");
